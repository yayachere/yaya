...
if (isset($_GET['ID']))
  {
    ...
    <center><p class="mt-3"><input name="print" type="button" class="btn btn-success" value="Print" id="printme" onClick="printContent('printme')"> <a href="viewvehicle.php" class="btn btn-primary">Back</a></p></center>
